...
//        mTextPaint.setShadowLayer(5, 3, 3, ShadowColor);
        ...
        Log.i("measurementsText",textWidth+"=="+getMeasuredWidth()+"=="+isCanScroll);
    ...
    public  void startScroll(){
        Log.i("measurementsText",isCanScroll+"==");
        ...
        public void onDraw() {
            try {
                synchronized (holder) {
                    ...
                    canvas.drawText("我在哪里啊",currentX, centeYLine+dip2px(getContext(),textHeight)/2,mTextPaint);
                    canvas.drawText("我在这里啊",currentX+ mTextPaint.measureText("我在哪里啊"), centeYLine+dip2px(getContext(),textHeight)/2,mTextPaint);
