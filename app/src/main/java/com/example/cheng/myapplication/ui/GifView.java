...
public class GifView extends View {
    ...
    private void setViewAttributes(Context context, AttributeSet attrs, int defStyle) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs,
                R.styleable.GifWidget, defStyle, R.style.Widget_GifView);

        //-1 is default value
        mMovieResourceId = array.getResourceId(R.styleable.GifWidget_gifs, -1);
        mPaused = array.getBoolean(R.styleable.GifWidget_pauseds, false);
...
//        }
    ...
    public void setListener(AnimationStop animationStop) {
        this.animationStop = animationStop;
    }

    public interface AnimationStop {
        void callBack();
    }
}